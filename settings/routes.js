...
const configure = (app, logger) => {
  ...
  app.post("/api/jobs/create", permit.context.builder, api.jobs.create);

  app.get("/api/jobs/getJobs/:id", permit.context.builder, api.jobs.getJobs);

  app.get(
    "/api/jobs/getJobsByuserId/:id",
    permit.context.builder,
    api.jobs.getJobsByuserId
  );

  app.get("/api/jobs/getAllJobs", permit.context.builder, api.jobs.getAllJobs);
  ...
  app.put("/api/jobs/update/:id", permit.context.builder, api.jobs.update);
  ...
  app.post("/api/jobs/jobsFilter", permit.context.builder, api.jobs.jobsFilter);
  ...
  app.get("/api/jobs/search", permit.context.builder, api.jobs.search);

  // category routes

  app.post("/api/category/create", permit.context.builder, api.category.create);
  ...
  app.post("/api/Apply/create", permit.context.builder, api.apply.create);
  ...
  app.get(
    "/api/Apply/listByJobId/:id",
    permit.context.builder,
    api.apply.listByJobId
  );
  app.get(
    "/api/Apply/listByapplyJobIdAnduserId/:userId/:applyId",
    permit.context.builder,
    api.apply.listByapplyJobIdAnduserId
  );
  ...
  app.post("/api/wishlist/create", permit.context.builder, api.wishlist.create);
  ...
  // );
  app.get(
    "/api/messages/getOldChat",
    permit.context.builder,
    api.message.getOldChat
  );
